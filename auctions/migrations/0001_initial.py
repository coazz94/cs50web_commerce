# Generated by Django 4.1.1 on 2022-10-08 15:19
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('EL', 'Electronic'), ('CA', 'Car'), ('FO', 'Food'), ('SP', 'Sport'), ('SA', 'Smartphones')], default='not_defined', max_length=15)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('listing', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='listings', to='auctions.listing')),
